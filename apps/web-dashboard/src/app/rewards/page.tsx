  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-10">
      <div className="mb-6">
        ...
        <h1 className="mt-2 text-2xl font-bold text-gray-100">FHE Rewards</h1>
        <p className="mt-1 text-sm text-gray-500">
          View and claim encrypted DePIN rewards using Fhenix FHE.
        </p>
      </div>
      <div className="rounded-xl border border-gray-800 bg-gray-900 p-6 text-center text-sm text-gray-500">
        Fhenix integration coming in the next build cycle.
      </div>
    </main>
  );
}
